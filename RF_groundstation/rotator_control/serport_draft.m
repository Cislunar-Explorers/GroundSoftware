...
%fopen(s);
%ber = [20, 10];
ber(1,1) = 123.5; ber(1,2) = 77.0;
az = 2*(360+ber(1,1));
el = 2*(360+ber(1,2));
%az = 10*(360+az);
%el=10*(360+el);
aztho = (az-mod(az,1000))/1000;
azhun = (az-aztho*1000-mod(az,100))/100;
azten = (az-aztho*1000-azhun*100-mod(az,10))/10;
azone = (az-aztho*1000-azhun*100-azten*10-mod(az,1));
azdec = mod(az,1);
eltho = (el-mod(el,1000))/1000;
elhun = (el-eltho*1000-mod(el,100))/100;
elten = (el-eltho*1000-elhun*100-mod(el,10))/10;
elone = (el-eltho*1000-elhun*100-elten*10-mod(el,1));  
eldec = mod(el,1);
V1 = ['3',num2str(eltho)];
V2 = ['3',num2str(elhun)];
V3 = ['3',num2str(elten)];
...
H3 = ['3',num2str(azten)];
H4 = ['3',num2str(azone)];
instring = ['57',H1,H2,H3,H4,'02',V1,V2,V3,V4,'02','2F','20'];
%}
%j = 10
